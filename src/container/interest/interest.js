...
let img =require("../../lib/img/G0018056.JPG")
export default class Interest extends React.Component {
    ...
    render() {
        ...
        let jsonsty;
        if (this.props.jsonsty){

            jsonsty= this.props.jsonsty
        }
        ...
        return (
            ...
            >
                {this.imgArray.map((item,index)=>{
                    ...
                    let keyaaa = "aqaddfa"+index+"556"+item

                   return <Element  key={keyaaa}
